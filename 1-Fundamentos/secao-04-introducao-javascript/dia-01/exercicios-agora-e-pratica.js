...
//let salarioBase = salarioBruto - (salarioBruto * aliquota); <INSS>
...
console.log( "O salário base é de R$" + salarioBase + " ,somente tendo a dedução do INSS, temos ainda que retirar o Imposto de Renda deste valor, para termos o resultado correto");

let salarioIr;

if (salarioBase <= 1903.98){
    salarioIr = salarioBase;
}
else if (salarioBase >= 1903.99 && salarioBase <= 2826.65) {
    salarioIr = salarioBase - (salarioBase * 0.075 - 142.8);
}
else if (salarioBase >= 2826.66 &&  salarioBase <= 3751.05){
    salarioIr = salarioBase - (salarioBase * 0.15 - 354.8);
}
else if (salarioBase >= 3751.06 && salarioBase <= 4664.68){
    salarioIr = salarioBase - (salarioBase * 0.225 - 636.13);
}
else if (salarioBase >= 4664.69){
    salarioIr = salarioBase - (salarioBase * 0.275 - 869.36);
} 
else {
